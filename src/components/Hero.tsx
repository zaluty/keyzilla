      ...
      <div className="container relative">
        ...
        <div className="flex justify-center mt-8 ">
          <div className="inline-flex relative">
            <h1 className='text-7xl sm:text-9xl font-bold tracking-tightner text-center inline-flex'>Keyzilla</h1>
        ...
        <div className="flex justify-center">
          <p className='text-xl text-center mt-8 max-w-md'>A simple and secure API key management platform Built for teal developers.</p>
        </div>
        <div className="flex justify-center mt-8">
          <SignedOut>
            <SignUpButton mode='modal'>
              <button className='bg-white text-black py-3 px-5 rounded-lg font-medium'>Start for free</button>
            </SignUpButton>
          </SignedOut>
          <SignedIn>
            <Link href="/dashboard">
              <button className='bg-white text-black py-3 px-5 rounded-lg font-medium'>Dashboard</button>
            </Link>
          </SignedIn>
        </div>
