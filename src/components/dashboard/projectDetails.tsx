...
import { CircleHelp, EllipsisVertical, FileQuestionIcon, Loader } from "lucide-react"
        ...
        <Sheet>
            <TooltipProvider>
                <Tooltip>
                    ...
                    <TooltipContent>
                        See project details and usage
                    </TooltipContent>
                </Tooltip>
            </TooltipProvider>
            <SheetContent className="p-4 bg-white dark:bg-black rounded-lg shadow-lg">
                <SheetHeader className="mb-4">
                    <SheetTitle className="text-xl font-bold">Usage</SheetTitle>
