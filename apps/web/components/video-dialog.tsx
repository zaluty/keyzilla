        ...
        <div className="relative">
            <div className="relative cursor-pointer" onClick={openVideo}>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    >
                        <div
                            className={`flex items-center justify-center border border-neutral-800 rounded-full size-20 transition-all ease-out duration-300 backdrop-blur-2xl relative ${isPlayHovered ? " scale-105" : "scale-100"
                                }`}
                        >
                            <Play
